...
namespace ProjectControlsReportingTool.API.Migrations
{
    ...
    [Migration("20250811231437_InitialCreate")]
            ...
            modelBuilder.Entity("ProjectControlsReportingTool.API.Models.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ab986eab-b558-466c-8684-cb48c97cfe96"),
                            CreatedDate = new DateTime(2025, 8, 11, 23, 14, 36, 750, DateTimeKind.Utc).AddTicks(5982),
                            Department = 1,
